...
const REVIEWS = [
  ...
  },
  {
    ...
    text: 'Потрясающая атмосфера и глубина подачи. Без лишней "воды", только чистая теори�� визуального языка и фундаментальный анализ классических лент.',
    rating: 5,
    tag: 'Выпуск 2024'
  },
  {
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-background text-on-surface relative selection:bg-secondary selection:text-background">
      ...
      <section className="relative py-28 px-[5vw] bg-surface-container">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start max-w-7xl mx-auto">
          {/* Sticky Left Column */}
          <div className="md:col-span-5 sticky top-32">
            <span className="font-mono-subtitle text-[11px] text-secondary tracking-[0.25em] uppercase mb-4 block">
              ПРОБЛЕМА ВОСПРИЯТИЯ
            </span>
            <h2 className="font-display text-4xl sm:text-5xl md:text-6xl mb-6 leading-tight text-on-surface">
              КОГДА КИНО
              <br />
              СТАНОВИТСЯ
              <br />
          ...
          <div className="md:col-span-7 flex flex-col gap-16 md:gap-24">
            {/* Scene 01 */}
            <div className="relative cinematic-frame p-8 md:p-10 bg-background/40 backdrop-blur-sm border-t border-b border-on-surface/20 overflow-hidden">
              <span className="font-mono-subtitle text-[12px] text-secondary mb-4 block tracking-[0.2em]">
                SCENE 01: THE OVERLOAD
              </span>
              <p className="font-display text-2xl md:text-3xl leading-snug mb-6 text-on-surface">
                Современный зритель потребляет 5000 визуальных образов в день.
              </p>
              <p className="font-sans text-sm md:text-base text-on-surface-variant/70 leading-relaxed">
                Большинство из них забываются через 5 секунд. Мы превратили искусство в фастфуд, теряя глубину кадра и намерение режиссера.
              </p>
            </div>

            {/* Scene 02 */}
            <div className="relative cinematic-frame p-8 md:p-10 bg-on-surface/5 border-t border-b border-secondary/40 overflow-hidden">
              <span className="font-mono-subtitle text-[12px] text-secondary mb-4 block tracking-[0.2em]">
                SCENE 02: THE AWAKENING
              </span>
              <h3 className="font-display text-2xl md:text-3xl leading-snug mb-6 text-secondary">
      ...
      <section className="py-28 px-[5vw] bg-background overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <span className="font-mono-subtitle text-[12px] tracking-[0.3em] text-secondary uppercase">
              CASTING CALL
            </span>
            <h2 className="font-display text-4xl sm:text-5xl md:text-6xl mt-4 text-on-surface">
              ДЛЯ КОГО ЭТОТ ПУТЬ
            </h2>
            <p className="font-mono-subtitle text-xs text-on-surface-variant/60 mt-4 max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-12">
            ...
            <div className="flex flex-col group cursor-pointer">
              <div className="aspect-[4/5] relative overflow-hidden mb-6 cinematic-frame bg-surface-container">
                <div
                ...
                <div className="absolute bottom-4 left-4 right-4 flex justify-between items-center text-[10px] font-mono-subtitle text-secondary">
                  <span>ROLE 01</span>
                  <span>VIEWER ARCHETYPE</span>
                </div>
              </div>
              <h4 className="font-display text-2xl mb-2 text-secondary group-hover:text-on-surface transition-colors">
                Искатели смыслов
              </h4>
      ...
      <section id="program" className="py-28 px-[5vw] bg-surface-container">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 pb-8 border-b border-on-surface/20 gap-6">
            <div>
              <span className="font-mono-subtitle text-[11px] tracking-[0.25em] text-secondary uppercase">
                CURRICULUM Breakdown
              </span>
              <h2 className="font-display text-4xl sm:text-5xl text-on-surface mt-2">
                ПРОГРАММА КУРСА
              </h2>
            </div>
            <p className="font-mono-subtitle text-xs text-on-surface-variant/70 max-w-md">
              ...
              <button
                ...
                className={`p-4 border text-left transition-all duration-300 cursor-pointer ${
                  activeModuleId === mod.id
                    ...
                    : 'border-on-surface/10 bg-background/30 text-on-surface/70 hover:border-on-surface/30'
                }`}
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center bg-background/50 p-8 sm:p-12 border border-on-surface/10 relative overflow-hidden">
            {/* Left Info Column */}
            <div className="lg:col-span-6 space-y-6">
              <div className="flex items-center gap-4 text-xs font-mono-subtitle text-secondary">
              ...
              <h3 className="font-display text-3xl sm:text-4xl text-on-surface">
                {activeModule.title}
              </h3>

              <p className="font-mono-subtitle text-xs text-secondary uppercase tracking-wider">
              ...
              <div className="pt-4 border-t border-on-surface/10">
                <h4 className="font-mono-subtitle text-xs text-on-surface uppercase tracking-widest mb-4">
                ...
                <ul className="space-y-3">
                  {activeModule.topics.map((topic, i) => (
                    <li key={i} className="flex items-start gap-3 text-xs sm:text-sm text-on-surface-variant">
                      <span className="text-secondary font-mono-subtitle mt-0.5">0{i + 1}.</span>
                      <span>{topic}</span>
                    </li>
                  ))}
                </ul>
            ...
            <div className="lg:col-span-6">
              <div className="relative aspect-video bg-surface rounded-sm border border-secondary/30 overflow-hidden group">
                <img
                ...
                {isOverlayEnabled && (
                  <div className="absolute inset-0 pointer-events-none">
                    ...
                    <div className="w-full h-full grid grid-cols-3 grid-rows-3 border border-secondary/20">
                      <div className="border-r border-b border-secondary/20" />
                      <div className="border-r border-b border-secondary/20" />
                      <div className="border-b border-secondary/20" />
                      <div className="border-r border-b border-secondary/20" />
                      <div className="border-r border-b border-secondary/30 bg-secondary/5" />
                      <div className="border-b border-secondary/20" />
                ...
                <button
                  ...
                  className="absolute bottom-4 right-4 bg-background/80 backdrop-blur-md border border-secondary/50 text-secondary font-mono-subtitle text-[10px] px-3 py-1.5 flex items-center gap-2 hover:bg-secondary hover:text-background transition-colors cursor-pointer"
                >
                  <Eye className="w-3.5 h-3.5" />
                  <span>СЕТКА КАДРА: {isOverlayEnabled ? 'ВКЛ' : 'ВЫКЛ'}</span>
                </button>

                <div className="absolute top-4 left-4 bg-background/80 border border-on-surface/20 px-3 py-1 font-mono-subtitle text-[10px] text-on-surface">
                  FRAME ANALYZER v1.0
                </div>
              </div>
            </div>
      ...
      {/* Authors Section */}
      <section id="authors" className="py-28 px-[5vw] bg-background">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <span className="font-mono-subtitle text-[11px] tracking-[0.3em] text-secondary uppercase">
              MASTERS & MENTORS
            </span>
            <h2 className="font-display text-4xl sm:text-5xl md:text-6xl mt-3 text-on-surface">
              АВТОРЫ КУРСА
            </h2>
            <p className="font-mono-subtitle text-xs text-on-surface-variant/60 mt-3 max-w-lg mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {AUTHORS.map((author, index) => (
              <div key={index} className="flex flex-col cinematic-frame p-6 bg-surface-container/60 border-t border-b border-on-surface/10 group">
                <div className="aspect-[3/4] relative overflow-hidden mb-6 bg-surface">
                  <img
                    src={author.photo}
                    alt={author.name}
                    loading="lazy"
                ...
                <span className="font-mono-subtitle text-[10px] text-secondary uppercase tracking-widest block mb-1">
                  {author.role}
                </span>
                ...
                <blockquote className="mt-auto pt-4 border-t border-on-surface/10 font-mono-subtitle text-[11px] italic text-secondary leading-relaxed">
                  "{author.quote}"
                </blockquote>
              </div>
            ))}
      ...
      {/* Reviews Section */}
      <section id="reviews" className="py-28 px-[5vw] bg-surface-container">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="font-mono-subtitle text-[11px] tracking-[0.3em] text-secondary uppercase">
              STUDENT TESTIMONIALS
            </span>
            <h2 className="font-display text-4xl sm:text-5xl text-on-surface mt-3">
              ОТЗЫВЫ ВЫПУСКНИКОВ
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {REVIEWS.map((rev, i) => (
              <div key={i} className="p-8 bg-background border border-on-surface/10 flex flex-col justify-between">
                <div>
                  <div className="flex justify-between items-center mb-6">
                    <span className="font-mono-subtitle text-[10px] text-secondary border border-secondary/30 px-2.5 py-1">
                      {rev.tag}
                    </span>
                    <div className="flex text-secondary gap-1 text-xs">
                ...
                <div className="pt-4 border-t border-on-surface/10">
                  <h4 className="font-display text-lg text-on-surface">{rev.name}</h4>
                  <span className="font-mono-subtitle text-[11px] text-secondary/80 block">{rev.occupation}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="plans" className="py-28 px-[5vw] bg-background">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <span className="font-mono-subtitle text-[11px] tracking-[0.3em] text-secondary uppercase">
              ENROLLMENT OPTIONS
            ...
            <p className="font-mono-subtitle text-xs text-on-surface-variant/60 mt-3 max-w-md mx-auto">
            ...
            {PLANS.map((plan) => (
              <div
                ...
                className={`flex flex-col p-8 sm:p-10 border transition-all duration-300 relative ${
                  plan.popular
                    ? 'border-secondary bg-surface-container shadow-2xl shadow-secondary/10'
                    : 'border-on-surface/15 bg-surface-container/40'
                }`}
              >
                {plan.popular && (
                  <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-secondary text-background font-mono-subtitle text-[10px] tracking-[0.2em] px-4 py-1 uppercase font-bold">
                    ПОПУЛЯРНЫЙ ВЫБОР
                  </div>
                )}

                <span className="font-mono-subtitle text-[11px] text-secondary tracking-[0.2em] uppercase block mb-1">
                  {plan.subtitle}
                </span>

                <h3 className="font-display text-3xl text-on-surface mb-4">
                  {plan.title}
                </h3>

                <div className="mb-6 pb-6 border-b border-on-surface/10">
                  <span className="font-display text-4xl font-bold text-secondary">
                    {plan.price}
                  </span>
                  <span className="font-mono-subtitle text-[11px] block text-on-surface-variant/60 mt-1">
                    {plan.period}
                  </span>
                </div>
                ...
                <ul className="space-y-4 mb-10 flex-1">
                  {plan.features.map((feat, idx) => (
                    <li key={idx} className="flex items-start gap-3 text-xs sm:text-sm text-on-surface-variant">
                ...
                <button
                  ...
                  className={`w-full py-4 font-mono-subtitle text-xs tracking-[0.2em] uppercase font-semibold transition-all cursor-pointer ${
                    plan.popular
                      ...
                      : 'border border-on-surface text-on-surface hover:bg-on-surface hover:text-background'
                  }`}
                >
                  ВЫБРАТЬ ТАРИФ
                </button>
      ...
      {/* Footer */}
      <footer className="w-full relative bg-background border-t border-on-surface/20 flex flex-col md:flex-row justify-between items-center px-[5vw] py-12 gap-8">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          <a
            href="#"
            className="font-mono-subtitle text-xs text-on-surface/60 hover:text-secondary underline underline-offset-4 transition-colors"
          >
            INSTAGRAM
          </a>
          <a
        ...
        <div className="font-mono-subtitle text-[11px] text-on-surface/40 text-center md:text-right leading-relaxed">
